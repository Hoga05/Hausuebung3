...
public class StreamsTest {
    ...
    public void test09() throws Throwable {
        ...
        assertEquals(CombatType.MELEE, weapon1.getCombtType());
    }
    ...
    public void testAverage2() {
        ...
        double getAverage = stream.average(list);
        assertEquals(expected, getAverage, 0.0);
    }


    @Test
    public void testUpperCase2() {
        String[] strings = new String[]{"test", "hallo"};
        Streams instance = new Streams();
        List<String> expResult = Arrays.asList("TEST", "HALLO");
        List<String> result = instance.upperCase(strings);
        assertEquals(expResult, result);
    }
